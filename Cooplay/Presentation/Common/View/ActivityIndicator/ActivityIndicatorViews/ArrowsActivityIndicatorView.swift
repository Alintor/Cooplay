...
final class ArrowsActivityIndicatorView: UIView {
    ...
    init() {
        ...
        leftArrowImageView.image = R.image.commonGamepadArrow()
        leftArrowImageView.tintColor = R.color.textSecondary()
        leftArrowImageView.contentMode = .scaleAspectFit
        let rightArrowImageView = UIImageView(frame: .zero)
        rightArrowImageView.image = R.image.commonGamepadArrow()
        rightArrowImageView.tintColor = R.color.textSecondary()
        ...
        topArrowImageView.image = R.image.commonGamepadArrow()
        topArrowImageView.tintColor = R.color.textSecondary()
        ...
        bottomArrowImageView.image = R.image.commonGamepadArrow()
        bottomArrowImageView.tintColor = R.color.textSecondary()
